...
@Entity
@Table(name = "jackpot_contribution_configuration")
@Getter
@Setter@NoArgsConstructor
@AllArgsConstructor
@Builder
public class JackpotContributionConfiguration {
    ...
    @Column(name = "min_contribution_pct", precision = 5, scale = 2)
    private BigDecimal minContributionPct;
